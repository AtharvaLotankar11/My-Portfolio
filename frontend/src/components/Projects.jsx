    ...
    return (
        <section id="projects" className="py-20 bg-secondary/30 relative overflow-hidden">
            ...
            <div className="absolute inset-0 -z-10">
                <div className="absolute top-[10%] left-[5%] w-80 h-80 bg-pink-500/20 rounded-full blur-3xl animate-float"></div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {projects.map((project, index) => (
                        <motion.div
                            ...
                            className="glass-effect p-6 rounded-xl border border-white/10 hover:border-accent/50 transition-all duration-500 group relative overflow-hidden"
                            style={{
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-accent transition-colors duration-300 group-hover:scale-105 inline-block">
                                    {project.title}
                                </h3>
                                ...
                                <div className="flex gap-4 mt-auto">
                                    {project.links.map((link, idx) => (
                                        <motion.a
                                            ...
                                            className="text-gray-400 hover:text-accent transition-all duration-300 text-lg magnetic-hover"
