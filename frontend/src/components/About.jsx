    ...
    return (
        <section id="about" className="py-20 bg-secondary/30 relative overflow-hidden">
            ...
            <div className="absolute inset-0 -z-10">
                <div className="absolute top-[15%] left-[10%] w-80 h-80 bg-accent/20 rounded-full blur-3xl animate-float"></div>
                <div className="absolute bottom-[25%] right-[15%] w-72 h-72 bg-purple-600/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '2.5s' }}></div>
            </div>
            ...
            <div className="container mx-auto px-6">
                ...
                <div className="grid md:grid-cols-1 gap-8 max-w-4xl mx-auto">
                    ...
                    >
                        ...
                        <h3 className="text-xl font-semibold mb-4 text-accent relative z-10 group-hover:scale-105 transition-transform duration-300">🎓 Education & Skills</h3>
